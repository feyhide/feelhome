...
const UpdateListing = () => {
    ...
    <main className='p-2 md:p-3 w-screen flex flex-col justify-center items-center font-sub tracking-[-1px] mx-auto mt-[100px]'>
        <h1 className='text-2xl md:text-5xl font-bold text-center tracking-[-1.5px] md:tracking-[-3px] mt-10 mb-3'>Update Listing</h1>
        <form onSubmit={handleSubmit} className='flex flex-col font-semibold md:gap-4 gap-10 p-5 md:p-10 rounded-xl bg-white w-[80%] sm:flex-row'>
            ...
            <div className='flex items-center justify-center flex-col gap-2 md:p-3 flex-1'>
                ...
                <button disabled={loading} onClick={() => handleDeleteListing()} className='w-full md:w-1/2 p-2 md:p-3 rounded-lg bg-red-600 text-white'>{loading ? "Loading...": 'Delete Listing'}</button>
                <button disabled={loading} className=' p-2 md:p-3 rounded-lg w-full md:w-1/2 bg-green-600 text-white'>{loading ? "Loading...": 'Update Listing'}</button>
